...
public class PullToRefreshListView extends ListView implements OnScrollListener{
	...
	private final static int headheight = 300;										// at bottom, trigger
														// load more.
...
//            					&& (mFooterView.getBottomMargin() > 0 || diff < 0)) {
//            				// last item, already pulled up or want to pull up.
//            				updateFooterHeight(-diff / OFFSET_RADIO);
//                        }
//                    }
//                }
//
...
//    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt){
        ...
        if(!hasResetHeader&&mEnablePullRefresh){
...
//					+ getLastVisiblePosition());
			...
			// Toast.makeText(getContext(), "aaa"+getLastVisiblePosition()+"bb"+mTotalItemCount+"cc"+deltaY, Toast.LENGTH_SHORT).show();
