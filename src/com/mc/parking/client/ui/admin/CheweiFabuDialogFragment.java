...
public class CheweiFabuDialogFragment extends DialogFragment
{
	...
	public CheweiFabuDialogFragment(TextView cheweiView){
	...
	public Dialog onCreateDialog(Bundle savedInstanceState)
	{
		...
		View view = inflater.inflate(R.layout.fragment_admin_chewei_fabu, null);
								...
								new SafeAsyncTask<Object>() {
							        ...
							        protected void onPreExecute() {
										if (progressDialog == null){
								            ...
								            progressDialog.setMessage("正在发布,请等待...");
								        }
										progressDialog.show();
							        }
