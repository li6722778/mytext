...
public class NetWorkActivity extends Activity implements OnClickListener {
	...
	private BaseToggleButton switchWifi, switchGprs;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switchWifi = (BaseToggleButton) findViewById(R.id.switch_wifi);
		switchGprs = (BaseToggleButton) findViewById(R.id.switch_liuliang);
		...
		switchWifi.setOnChangedListener(new OnChangedListener() {
		...
		switchGprs.setOnChangedListener(new OnChangedListener() {
