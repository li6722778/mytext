...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    private byte[] encodeParameters(Map<String, Object> params, String paramsEncoding) {
    	...
    	String jsonString = gsonBuilder.toJson(params, type);
...
//	                	transferToString = obj.toString();
//	                }else if(obj instanceof Double){
//	                	double _temp = (Double)obj;
//	                	transferToString = String.valueOf(_temp);
//	                }else if(obj instanceof Float){
//	                	float _temp = (Float)obj;
//	                	transferToString = String.valueOf(_temp);
//	                }else if(obj instanceof Double){
//	                	long _temp = (Long)obj;
//	                	transferToString = String.valueOf(_temp);
//	                }else if(obj instanceof Short){
//	                	short _temp = (Short)obj;
//	                	transferToString = String.valueOf(_temp);
//	                }else if(obj instanceof Integer){
//	                	int _temp = (Integer)obj;
//	                	transferToString = String.valueOf(_temp);
//	                }else if(obj instanceof Integer){
//	                	int _temp = (Integer)obj;
//	                	transferToString = String.valueOf(_temp);
//	                }
//	                encodedParams.append(URLEncoder.encode(transferToString, paramsEncoding));
//                }else{
//                	encodedParams.append("");
//                }
//                
